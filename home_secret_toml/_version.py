...
__version__ = "0.1.2"
__short_description__ = "A unified TOML-based secret management system for local development environments with lazy loading, alias-based security, and automatic IDE integration."
__license__ = "MIT"
__author__ = "Sanhe Hu"
